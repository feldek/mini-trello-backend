...
const COMMON_OPTIONS = {
  ...
  "reselect": "Use [createMemoSelector, TSelector] from \"@lc/utils\"",
  "@lc/rorm-records": "Package will be dropped soon - normalize using @lc/graphql-client package and put selector in domain folder",
};
